...
public class Moving : MonoBehaviour
{
    ...
    public float Rotation(Vector3 direction)
    {
        ...
        float newAngle = Mathf.MoveTowardsAngle(currentAngle, targetAngle, gene.rotationSpeed * GameManager.Instance.RunningSpeed * Time.deltaTime);
    ...
    void Update()
    {
        ...
        float movementDistance = gene.movementSpeed * GameManager.Instance.RunningSpeed * Time.deltaTime;
        ...
        if (angleDifference < gene.rotationSpeed * 0.5f)
        {
