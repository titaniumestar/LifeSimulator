...
public class ObjectSpawner : MonoBehaviour
{
    ...
    void SpawnObject(GameObject[] objectTypeArray, List<GameObject> worldObjectList, Vector3 currentPosition, float spawnRangeRadius, Vector3 worldMinRange, Vector3 worldMaxRange)
    {
    ...
    void Update()
    {
        ...
        if (WaitingTime <= 0)
        {
            ...
            if (WorldObjectList.Count < MaxSpawnQuantity) SpawnObject
            (
                ObjectTypeArray,
                WorldObjectList,
                transform.position,
